...
class _WeatherMapViewState extends State<WeatherMapView> {
  ...
  Marker buildMarker(WindSpeed? velocity, MapCoordinates? coordinates) {
        ...
        builder: (context, snapshot) {
          ...
          return FlutterMap(
            ...
            options: MapOptions(
              ...
              onPositionChanged: (camera, hasGesture) { _mapZoom = camera.zoom; setState(() {
            ...
            children: [
              TileLayer(
                ...
                //tileBuilder: AppStyle.brightness == Brightness.dark ? darkModeTileBuilder : null,
              ),
              MarkerLayer(
